import StockChart, { StockValues } from "@/components/main/charts/StockChart";
import CardIndicator from "@/components/main/indicators/CardIndicator";
...
export default async function Page({
  ...
  return (
    <div className="mx-32 h-full flex-1 flex flex-col gap-3">
      ...
      <StockChart values={stockvalue} className="w-full" />
